  ...
  const PAGES = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: "roi-environment.html", label: "ROI: Environment", desc: "Sector-specific" },
        { href: "roi-smart-city.html", label: "ROI: Smart City", desc: "Sector-specific" },
        { href: "roi-mining.html", label: "ROI: Mining", desc: "Sector-specific" },
        { href: "roi-water-treatment.html", label: "ROI: Water Treatment", desc: "Sector-specific" },
        { href: "roi-hospital-icu.html", label: "ROI: Hospital ICU", desc: "Sector-specific" },
        { href: "roi-autonomous-vehicles.html", label: "ROI: Autonomous Vehicles", desc: "Sector-specific" },
        { href: "roi-chemical-plant.html", label: "ROI: Chemical Plant", desc: "Sector-specific" },
        { href: "roi-smart-grid.html", label: "ROI: Smart Grid", desc: "Sector-specific" },
